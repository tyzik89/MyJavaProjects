 ...
 * 1) Берём опорный элемент (выбрается либо случайно, либо первый, либо по особому алгоритму)
 * 2) Сравниваем все эелементы с опорным, разбивая массив на две несортированные части,
 *    элементы которых больше и меньше опорного;
 * 3) Рекурсивно вызываем алгоритм для двух несортированных частей массива;
 * 4) Соединяем обе части + опорный элемент
 */
