...
/**
 * Поиск в ширину
 * 1) Начинаем поиск с корня.
 * 2) Если корень не подходит, добавляем элемент в список уже проверенных элементов. Если подходит - завершаем поиск.
 * 3) Берём всех потомков и добавляем в список проверяемых.
 * 4) Для каждого добавленного выполняем п.2
 */
