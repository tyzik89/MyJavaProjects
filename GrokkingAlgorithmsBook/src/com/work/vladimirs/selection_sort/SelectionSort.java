 ...
 * 1) Находим наименьший/наибольщий элемент;
 * 2) Добавляем его в результирующий массив, удаляя из массива неотсортированного;
 * 3) Ищем следущий и т.д. пока в неотсортированном массиве не закончатся элементы.
 */
