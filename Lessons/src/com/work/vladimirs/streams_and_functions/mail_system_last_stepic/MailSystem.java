...
public class MailSystem {
    ...
    public static void main(String[] args) {
        ...
        SalaryMessage salary1 = new SalaryMessage("Facebook", "Mark Zuckerberg", 1);
        SalaryMessage salary2 = new SalaryMessage("FC Barcelona", "Lionel Messi", Integer.MAX_VALUE);
        SalaryMessage salary3 = new SalaryMessage(randomFrom, randomTo, randomSalary);
